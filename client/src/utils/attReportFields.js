...
export const getVisibleFields = (teacherTypeKey) => {
    ...
    return Object.keys(fieldVisibility).filter((fieldName) => fieldVisibility[fieldName].includes(teacherTypeKey));
};
...
export const getTeacherTypeKeyByTeacherTypeId = (dataProvider, teacherTypeId) => {
    ...
    return dataProvider
        .getOne('teacher_type', { id: teacherTypeId })
