...
export class AddReferenceFieldsSupport1732915200000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE INDEX \`questions_teacher_type_id_idx\` ON \`questions\` (\`teacherTypeReferenceId\`)`);
    await queryRunner.query(`CREATE INDEX \`questions_question_type_id_idx\` ON \`questions\` (\`questionTypeReferenceId\`)`);
    ...
    await queryRunner.query(`CREATE INDEX \`teachers_teacher_type_id_idx\` ON \`teachers\` (\`teacherTypeReferenceId\`)`);
    ...
    await queryRunner.query(`CREATE INDEX \`att_reports_activity_type_idx\` ON \`att_reports\` (\`activityTypeReferenceId\`)`);
    ...
    await queryRunner.query(`CREATE INDEX \`working_dates_teacher_type_id_idx\` ON \`working_dates\` (\`teacherTypeReferenceId\`)`);
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX \`working_dates_teacher_type_id_idx\` ON \`working_dates\``);
    await queryRunner.query(`CREATE INDEX \`working_dates_teacher_type_id_idx\` ON \`working_dates\` (\`teacher_type_id\`)`);
