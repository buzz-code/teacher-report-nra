...
export class SeedPriceDefaults1763412506251 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        const pricesToSeed = [
            ...
            { userId: 0, code: 'pds.interfere_teach_multiplier', description: 'פד"ס - תעריף התערבות/הוראה', price: 12.00 },
            ...
            { userId: 0, code: 'special.student_multiplier', description: 'חינוך מיוחד - תעריף לכל תלמיד', price: 6.00 },
            { userId: 0, code: 'special.phone_discussion_bonus', description: 'חינוך מיוחד - בונוס דיון טלפוני', price: 15.00 },
        ];
