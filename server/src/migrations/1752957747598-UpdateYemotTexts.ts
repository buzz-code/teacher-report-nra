...
export class UpdateYemotTexts1752957747598 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    // Ensure filepath column exists before seeding (absent on fresh DBs since
    // AddMetadataAndFilepathFields runs later in migration history)
    ...
    const texts = [
      ...
      // Report flow
      {
        name: 'REPORT.CHOOSE_DATE_TYPE',
        text: 'לדווח על היום הקישי 1, לדווח על תאריך אחר הקישי 2, לשמוע דיווחים הקישי 3',
      },
      ...
      {
        name: 'TEACHER.CONFIRM_TEACHER_SINGLE',
        text: 'האם הכוונה למורה {teacherName}? לאישור הקישי 1, לשינוי הקישי 2',
      },
      ...
      {
        name: 'REPORT.VALIDATION_CONFIRM_MANHA',
        text: 'נא לאשר את הדיווח: מורה {teacherName}, חוליה רגילה {hulia1}, חוליה גדולה {hulia2}, צפיות {watch}, מסירות {teach}, ילקוט {yalkut}, דיונים {discuss}, עזרה {help}, חוליה 2 {hulia3}. לאישור הקישי 1, לשינוי הקישי 2',
      },
      {
        name: 'REPORT.VALIDATION_CONFIRM_PDS',
        text: 'נא לאשר את הדיווח: צפיה/פרטני {watchIndiv}, מסירה/מעורבות {teachInterf}, דיונים {discuss}. לאישור הקישי 1, לשינוי הקישי 2',
      },

      // Previous reports messages
      {
        name: 'REPORT.SEMINAR_KITA_PREVIOUS',
        text: 'דיווח מתאריך {date}, שיעורים {lessons}, צפיה/פרטני {watchIndiv}, מסירה/מעורבות {teachInterf}, דיונים {discuss}, חיסורים {absence}, קמל {kamal}, תלמידות {students}. לאישור הקישי 9, לעריכה הקישי מספר אחר',
      },
      {
        name: 'REPORT.MANHA_PREVIOUS',
        text: 'דיווח מתאריך {date}, מתודיקה {methodic}, טלפון {phone}, חוליה רגילה {hulia1}, חוליה גדולה {hulia2}, צפיות {watch}, מסירות {teach}, מ.ז. תלמידות {studentTz}, ילקוט {yalkut}, דיונים {discuss}, עזרה {help}, חוליה 2 {hulia3}. לאישור הקישי 9, לעריכה הקישי מספר אחר',
      },
      {
        name: 'REPORT.PDS_PREVIOUS',
        text: 'דיווח מתאריך {date}, צפיה/פרטני {watchIndiv}, מסירה/מעורבות {teachInterf}, דיונים {discuss}. לאישור הקישי 9, לעריכה הקישי מספר אחר',
      },
      {
        name: 'REPORT.KINDERGARTEN_PREVIOUS',
        text: 'דיווח מתאריך {date}, תלמידות {students}, דיון {discuss}, תפקוד טוב {studentsGood}, כניסה בזמן {enterOnTime}, יציאה בזמן {exitOnTime}, צפיה קולקטיבית {collective}. לאישור הקישי 9, לעריכה הקישי מספר אחר',
      },
      {
        name: 'REPORT.SPECIAL_EDUCATION_PREVIOUS',
        text: 'דיווח מתאריך {date}, שיעורים {lessons}, צופות {studentsWatched}, מוסרות {studentsTeached}, דיון טלפוני {phoneDiscuss}, מורה מנחה {trainingTeacher}, התמחות {speciality}. לאישור הקישי 9, לעריכה הקישי מספר אחר',
      },
